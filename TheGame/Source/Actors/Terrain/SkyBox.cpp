...
SkyBox::SkyBox(Entity *parent, Arwing *arwing) : Cube(parent, glm::vec3(SKYBOX_X, SKYBOX_Y, 0.1f), glm::vec2(SKYBOX_X / 1024, SKYBOX_Y / 512))
{
	name = "SKYBOX";
	size = glm::vec3(SKYBOX_X, SKYBOX_Y, 0.1f);
	this->arwing = arwing;
